...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_gensync__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<h1><a class="anchor" id="autotoc_md8486"></a>
Example</h1>
...
</div><!-- fragment --><p>or potentially expose one of the async versions as the default, with a <code>.sync</code> property on the function to expose the synchronous version. ```js module.exports = myOperation.errback; module.exports.sync = myOperation.sync; ````</p>
<h1><a class="anchor" id="autotoc_md8487"></a>
API</h1>
<h2><a class="anchor" id="autotoc_md8488"></a>
gensync(generatorFnOrOptions)</h2>
<p>Returns a function that can be "await"-ed in another <code>gensync</code> generator function, or executed via</p>
<ul>
<li><code>.sync(...args)</code> - Returns the computed value, or throws.</li>
<li><code>.async(...args)</code> - Returns a promise for the computed value.</li>
<li><code>.errback(...args, (err, result) =&gt; {})</code> - Calls the callback with the computed value, or error.</li>
</ul>
<h3><a class="anchor" id="autotoc_md8489"></a>
Passed a generator</h3>
<p>Wraps the generator to populate the <code>.sync</code>/<code>.async</code>/<code>.errback</code> helpers above to allow for evaluation of the generator for the final value.</p>
<h4><a class="anchor" id="autotoc_md8490"></a>
Example</h4>
<div class="fragment"><div class="line">const readFile = function* () {</div>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8491"></a>
...
<h4><a class="anchor" id="autotoc_md8492"></a>
Example</h4>
...
<h3><a class="anchor" id="autotoc_md8494"></a>
Example</h3>
...
<div class="line">  ]);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md8495"></a>
...
<h3><a class="anchor" id="autotoc_md8496"></a>
Example</h3>
<div class="fragment"><div class="line">const loadFiles = gensync(function* () {</div>
