...
<title>Food4uDoc: stream-http &lt;a href=&quot;https://travis-ci.org/jhiesey/stream-http&quot;&gt;&lt;img src=&quot;https://travis-ci.org/jhiesey/stream-http.svg?branch=master&quot; alt=&quot;Build Status&quot;/&gt;&lt;/a&gt;</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_stream-http__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
<div class="PageDoc"><div class="header">
  <div class="headertitle">
<div class="title">stream-http <a href="https://travis-ci.org/jhiesey/stream-http"><object type="image/svg+xml" data="https://travis-ci.org/jhiesey/stream-http.svg?branch=master" style="pointer-events: none;">Build Status</object></a> </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p><a href="https://saucelabs.com/u/stream-http"><object type="image/svg+xml" data="https://saucelabs.com/browser-matrix/stream-http.svg" style="pointer-events: none;">Sauce Test Status</object></a></p>
<p>This module is an implementation of Node's native <code>http</code> module for the browser. It tries to match Node's API and behavior as closely as possible, but some features aren't available, since browsers don't give nearly as much control over requests.</p>
...
<h1><a class="anchor" id="autotoc_md18989"></a>
What does it do?</h1>
...
<p>The following browsers support pseudo-streaming, where the data is available before the request finishes, but the entire response must be held in memory:</p><ul>
<li>Chrome</li>
<li>Safari &gt;= 5, and maybe older</li>
<li>IE &gt;= 10</li>
<li>Most other Webkit-based browsers, including the default Android browser</li>
</ul>
<p>All browsers newer than IE8 support binary responses. All of the above browsers that support true streaming or pseudo-streaming support that for binary data as well except for IE10. Old (presto-based) Opera also does not support binary streaming either.</p>
<h2><a class="anchor" id="autotoc_md18990"></a>
IE8 note:</h2>
<p>As of version 2.0.0, IE8 support requires the user to supply polyfills for <code>Object.keys</code>, <code>Array.prototype.forEach</code>, and <code>Array.prototype.indexOf</code>. Example implementations are provided in <a href="ie8-polyfill.js">ie8-polyfill.js</a>; alternately, you may want to consider using <a href="https://github.com/es-shims/es5-shim">es5-shim</a>. All browsers with full ES5 support shouldn't require any polyfills.</p>
<h1><a class="anchor" id="autotoc_md18991"></a>
How do you use it?</h1>
<p>The intent is to have the same API as the client part of the <a href="https://nodejs.org/api/http.html">Node HTTP module</a>. The interfaces are the same wherever practical, although limitations in browsers make an exact clone of the Node API impossible.</p>
<p>This module implements <code>http.request</code>, <code>http.get</code>, and most of <code>http.ClientRequest</code> and <code>http.IncomingMessage</code> in addition to <code>http.METHODS</code> and <code>http.STATUS_CODES</code>. See the Node docs for how these work.</p>
<h2><a class="anchor" id="autotoc_md18992"></a>
Extra features compared to Node</h2>
<ul>
<li>The <code>message.url</code> property provides access to the final URL after all redirects. This is useful since the browser follows all redirects silently, unlike Node. It is available in Chrome 37 and newer, Firefox 32 and newer, and Safari 9 and newer.</li>
...
<h2><a class="anchor" id="autotoc_md18993"></a>
Features missing compared to Node</h2>
<ul>
...
<h1><a class="anchor" id="autotoc_md18994"></a>
Example</h1>
<div class="fragment"><div class="line">http.get(&#39;/bundle.js&#39;, function (res) {</div>
<div class="line">    var div = document.getElementById(&#39;result&#39;);</div>
<div class="line">    div.innerHTML += &#39;GET /beep&lt;br&gt;&#39;;</div>
<div class="line"> </div>
<div class="line">    res.on(&#39;data&#39;, function (buf) {</div>
<div class="line">        div.innerHTML += buf;</div>
<div class="line">    });</div>
<div class="line"> </div>
<div class="line">    res.on(&#39;end&#39;, function () {</div>
<div class="line">        div.innerHTML += &#39;&lt;br&gt;__END__&#39;;</div>
<div class="line">    });</div>
<div class="line">})</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md18995"></a>
Running tests</h1>
<p>There are two sets of tests: the tests that run in Node (found in <code>test/node</code>) and the tests that run in the browser (found in <code>test/browser</code>). Normally the browser tests run on <a href="http://saucelabs.com/">Sauce Labs</a>.</p>
<p>Running <code>npm test</code> will run both sets of tests, but in order for the Sauce Labs tests to run you will need to sign up for an account (free for open source projects) and put the credentials in a <a href="https://github.com/defunctzombie/zuul/wiki/zuulrc"><code>.zuulrc</code> file</a>.</p>
<p>To run just the Node tests, run <code>npm run test-node</code>.</p>
<p>To run the browser tests locally, run <code>npm run test-browser-local</code> and point your browser to <code><a href="http://localhost:8080/__zuul">http://localhost:8080/__zuul</a></code></p>
<h1><a class="anchor" id="autotoc_md18996"></a>
License</h1>
