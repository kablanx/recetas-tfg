...
<title>Food4uDoc: PostCSS Runner Guidelines</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_postcss-modules-local-by-default_node_modules_postcss_docs_guidelines_runner.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<h1><a class="anchor" id="autotoc_md14659"></a>
1. API</h1>
<h2><a class="anchor" id="autotoc_md14660"></a>
...
<div class="line">    })</div>
<div class="line">];</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14661"></a>
2. Processing</h1>
<h2><a class="anchor" id="autotoc_md14662"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14663"></a>
...
<div class="fragment"><div class="line">processor.process(opts).then(function (result) {</div>
<div class="line">    // processing is finished</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14664"></a>
...
<h1><a class="anchor" id="autotoc_md14665"></a>
3. Output</h1>
<h2><a class="anchor" id="autotoc_md14666"></a>
...
<div class="fragment"><div class="line">processor.process(opts).catch(function (error) {</div>
...
<div class="line">    }</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14667"></a>
3.2. Display &lt;tt&gt;result.warnings()&lt;/tt&gt;</h2>
<p>PostCSS runners must output warnings from <code>result.warnings()</code>:</p>
<div class="fragment"><div class="line">result.warnings().forEach(function (warn) {</div>
...
<h2><a class="anchor" id="autotoc_md14668"></a>
...
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14669"></a>
4. Documentation</h1>
<h2><a class="anchor" id="autotoc_md14670"></a>
4.1. Document your runner in English</h2>
<p>PostCSS runners must have their <code>README.md</code> written in English. Do not be afraid of your English skills, as the open source community will fix your errors.</p>
...
<h2><a class="anchor" id="autotoc_md14671"></a>
...
<h2><a class="anchor" id="autotoc_md14672"></a>
