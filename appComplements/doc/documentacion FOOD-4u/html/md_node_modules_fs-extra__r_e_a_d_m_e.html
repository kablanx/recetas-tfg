...
<title>Food4uDoc: Node.js: fs-extra</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_fs-extra__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<p><a href="https://www.npmjs.org/package/fs-extra"><object type="image/svg+xml" data="https://img.shields.io/npm/v/fs-extra.svg" style="pointer-events: none;">npm Package</object></a> <a href="https://github.com/jprichardson/node-fs-extra/blob/master/LICENSE"><object type="image/svg+xml" data="https://img.shields.io/npm/l/express.svg" style="pointer-events: none;">License</object></a> <a href="http://travis-ci.org/jprichardson/node-fs-extra"><object type="image/svg+xml" data="https://img.shields.io/travis/jprichardson/node-fs-extra/master.svg" style="pointer-events: none;">build status</object></a> <a href="https://ci.appveyor.com/project/jprichardson/node-fs-extra/branch/master"><object type="image/svg+xml" data="https://img.shields.io/appveyor/ci/jprichardson/node-fs-extra/master.svg?label=windows%20build" style="pointer-events: none;">windows Build status</object></a> <a href="https://www.npmjs.org/package/fs-extra"><object type="image/svg+xml" data="http://img.shields.io/npm/dm/fs-extra.svg" style="pointer-events: none;">downloads per month</object></a> <a href="https://coveralls.io/github/jprichardson/node-fs-extra"><object type="image/svg+xml" data="https://img.shields.io/coveralls/github/jprichardson/node-fs-extra/master.svg" style="pointer-events: none;">Coverage Status</object></a> <a href="https://standardjs.com"><object type="image/svg+xml" data="https://img.shields.io/badge/code_style-standard-brightgreen.svg" style="pointer-events: none;">JavaScript Style Guide</object></a></p>
<h1><a class="anchor" id="autotoc_md8452"></a>
Why?</h1>
<p>I got tired of including <code>mkdirp</code>, <code>rimraf</code>, and <code>ncp</code> in most of my projects.</p>
<h1><a class="anchor" id="autotoc_md8453"></a>
Installation</h1>
<pre class="fragment">npm install --save fs-extra
</pre><h1><a class="anchor" id="autotoc_md8454"></a>
Usage</h1>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md8455"></a>
Sync vs Async vs Async/Await</h1>
...
<div class="line">async function copyFiles () {</div>
<div class="line">  try {</div>
<div class="line">    await fs.copy(&#39;/tmp/myfile&#39;, &#39;/tmp/mynewfile&#39;)</div>
<div class="line">    console.log(&#39;success!&#39;)</div>
<div class="line">  } catch (err) {</div>
<div class="line">    console.error(err)</div>
<div class="line">  }</div>
<div class="line">}</div>
<div class="line"> </div>
<div class="line">copyFiles()</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md8456"></a>
Methods</h1>
<h2><a class="anchor" id="autotoc_md8457"></a>
Async</h2>
<ul>
<li>copy</li>
<li>emptyDir</li>
...
<h2><a class="anchor" id="autotoc_md8458"></a>
Sync</h2>
<ul>
<li>copySync</li>
<li>emptyDirSync</li>
...
<h2><a class="anchor" id="autotoc_md8459"></a>
...
<h1><a class="anchor" id="autotoc_md8460"></a>
Third Party</h1>
<h2><a class="anchor" id="autotoc_md8461"></a>
TypeScript</h2>
...
<h2><a class="anchor" id="autotoc_md8462"></a>
...
<h2><a class="anchor" id="autotoc_md8463"></a>
Obtain Filesystem (Devices, Partitions) Information</h2>
...
<h2><a class="anchor" id="autotoc_md8464"></a>
Misc.</h2>
<ul>
...
<h1><a class="anchor" id="autotoc_md8465"></a>
...
<p><a href="https://github.com/feross/standard"><object type="image/svg+xml" data="https://cdn.rawgit.com/feross/standard/master/badge.svg" style="pointer-events: none;">js-standard-style</object></a></p>
...
<h2><a class="anchor" id="autotoc_md8466"></a>
...
<h2><a class="anchor" id="autotoc_md8467"></a>
Windows</h2>
...
<h1><a class="anchor" id="autotoc_md8468"></a>
Naming</h1>
...
<h1><a class="anchor" id="autotoc_md8469"></a>
Credit</h1>
...
<h1><a class="anchor" id="autotoc_md8470"></a>
License</h1>
