...
<title>Food4uDoc: Overview &lt;a href=&quot;https://travis-ci.org/lydell/js-tokens&quot;&gt;&lt;img src=&quot;https://travis-ci.org/lydell/js-tokens.svg?branch=master&quot; alt=&quot;Build Status&quot;/&gt;&lt;/a&gt;</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_js-tokens__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
<div class="PageDoc"><div class="header">
  <div class="headertitle">
<div class="title">Overview <a href="https://travis-ci.org/lydell/js-tokens"><object type="image/svg+xml" data="https://travis-ci.org/lydell/js-tokens.svg?branch=master" style="pointer-events: none;">Build Status</object></a> </div>  </div>
</div><!--header-->
<div class="contents">
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10339"></a>
Installation</h1>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md10340"></a>
Usage</h1>
<h3><a class="anchor" id="autotoc_md10341"></a>
&lt;tt&gt;jsTokens&lt;/tt&gt;</h3>
...
<h3><a class="anchor" id="autotoc_md10342"></a>
&lt;tt&gt;var token = matchToToken(match)&lt;/tt&gt;</h3>
...
</div><!-- fragment --><p>Takes a <code>match</code> returned by <code>jsTokens.exec(string)</code>, and returns a <code>{type: String, value: String}</code> object. The following types are available:</p>
<ul>
<li>string</li>
<li>comment</li>
<li>regex</li>
...
<h1><a class="anchor" id="autotoc_md10343"></a>
...
<h1><a class="anchor" id="autotoc_md10344"></a>
...
<h1><a class="anchor" id="autotoc_md10345"></a>
Limitations</h1>
...
<h3><a class="anchor" id="autotoc_md10346"></a>
...
<h3><a class="anchor" id="autotoc_md10347"></a>
...
</div><!-- fragment --><p>A human can easily understand that in the <code>number</code> line we’re dealing with division, and in the <code>regex</code> line we’re dealing with a regex literal. How come? Because humans can look at the whole code to put the <code>/</code> characters in context. A JavaScript regex cannot. It only sees forwards. (Well, ES2018 regexes can also look backwards. See the <a href="#es2018">ES2018</a> section).</p>
...
</div><!-- fragment --><p>The first line divides the <code>foo</code> variable with <code>2/g</code>. The second line calls the <code>foo</code> function with the regex literal <code>/= 2/g</code>. Again, since <code>jsTokens</code> only sees forwards, it cannot tell the two cases apart.</p>
...
<h3><a class="anchor" id="autotoc_md10348"></a>
ES2018</h3>
...
<h1><a class="anchor" id="autotoc_md10349"></a>
License</h1>
<p>[MIT](LICENSE). </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
