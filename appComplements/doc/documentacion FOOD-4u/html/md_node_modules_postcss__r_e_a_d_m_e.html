...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_postcss__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="contents">
<div class="textblock"><p><object type="image/svg+xml" data="http://postcss.github.io/postcss/logo.svg" style="pointer-events: none;" align="right" width="95" height="95">Philosopher’s stone, logo of PostCSS</object></p>
...
<p>PostCSS takes a CSS file and provides an API to analyze and modify its rules (by&#160;transforming&#160;them&#160;into&#160;an&#160;<a href="https://en.wikipedia.org/wiki/Abstract_syntax_tree">Abstract&#160;Syntax&#160;Tree</a>). This API can then be used by <a href="https://github.com/postcss/postcss#plugins">plugins</a> to&#160;do a&#160;lot of&#160;useful&#160;things, e.g.&#160;to&#160;find errors automatically insert vendor prefixes.</p>
<p><b>Support / Discussion:</b> <a href="https://gitter.im/postcss/postcss">Gitter</a><br  />
 <b>Twitter account:</b> <a href="https://twitter.com/postcss">@postcss</a><br  />
 <b>VK.com page:</b> <a href="https://vk.com/postcss">postcss</a><br  />
 <b>中文翻译</b>: <a class="el" href="postcss-modules-values_2node__modules_2postcss_2_r_e_a_d_m_e-cn_8md.html">`README-cn.md`</a></p>
...
<p><a href="https://evilmartians.com/?utm_source=postcss"><object type="image/svg+xml" data="https://evilmartians.com/badges/sponsored-by-evil-martians.svg" style="pointer-events: none;" width="236" height="54">Sponsored by Evil Martians</object> </a></p>
<h1><a class="anchor" id="autotoc_md13466"></a>
Sponsorship</h1>
<p>PostCSS needs your support. We are accepting donations <a href="https://opencollective.com/postcss/">at Open Collective</a>.</p>
<p><a href="https://tailwindcss.com/"><object type="image/svg+xml" data="https://refactoringui.nyc3.cdn.digitaloceanspaces.com/tailwind-logo.svg" style="pointer-events: none;" width="273" height="64">Sponsored by Tailwind CSS</object> </a></p>
<h1><a class="anchor" id="autotoc_md13467"></a>
Plugins</h1>
<p>Currently, PostCSS has more than 200 plugins. You&#160;can find all of the plugins in the <a href="https://github.com/postcss/postcss/blob/master/docs/plugins.md">plugins list</a> or in the <a href="http://postcss.parts">searchable catalog</a>. Below is a list of our favorite plugins — the best demonstrations of what can be built on top of PostCSS.</p>
...
<h2><a class="anchor" id="autotoc_md13468"></a>
Solve Global CSS Problem</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md13469"></a>
Use Future CSS, Today</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md13470"></a>
Better CSS Readability</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md13471"></a>
Images and Fonts</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md13472"></a>
Linters</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md13473"></a>
Other</h2>
<ul>
...
<h1><a class="anchor" id="autotoc_md13474"></a>
Syntaxes</h1>
...
<h1><a class="anchor" id="autotoc_md13475"></a>
Articles</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md13476"></a>
Books</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md13477"></a>
Usage</h1>
...
<h2><a class="anchor" id="autotoc_md13478"></a>
CSS-in-JS</h2>
...
<div class="line">    require(&#39;postcss-nested&#39;)</div>
<div class="line">  ]</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md13479"></a>
Parcel</h2>
...
<div class="line">  ]</div>
<div class="line">}</div>
</div><!-- fragment --><p>Parcel will even automatically install these plugins for you.</p>
...
<h2><a class="anchor" id="autotoc_md13480"></a>
Webpack</h2>
...
<div class="line">  ]</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md13481"></a>
Gulp</h2>
...
<div class="fragment"><div class="line">gulp.task(&#39;css&#39;, () =&gt; {</div>
...
<div class="line">})</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md13482"></a>
npm run / CLI</h2>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md13483"></a>
Browser</h2>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md13484"></a>
Runners</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md13485"></a>
JS API</h2>
...
<div class="line">      fs.writeFile(&#39;dest/app.css&#39;, result.css, () =&gt; true)</div>
<div class="line">      if ( result.map ) {</div>
<div class="line">        fs.writeFile(&#39;dest/app.css.map&#39;, result.map, () =&gt; true)</div>
<div class="line">      }</div>
<div class="line">    })</div>
<div class="line">})</div>
</div><!-- fragment --><p>Read the <a href="http://api.postcss.org/postcss.html">PostCSS API documentation</a> for more details about the JS API.</p>
...
<h2><a class="anchor" id="autotoc_md13486"></a>
Options</h2>
...
<h2><a class="anchor" id="autotoc_md13487"></a>
Treat Warnings as Errors</h2>
...
<div class="line">  plugins: [</div>
<div class="line">    require(&#39;autoprefixer&#39;),</div>
<div class="line">    require(&#39;postcss-fail-on-warn&#39;)</div>
<div class="line">  ]</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md13488"></a>
Contributing</h1>
<p><a class="el" href="stackframe_2_c_o_n_t_r_i_b_u_t_i_n_g_8md.html">Our contributing guidelines</a> will help you with making pull request to this project.</p>
<h1><a class="anchor" id="autotoc_md13489"></a>
Editors &amp; IDE Integration</h1>
<h2><a class="anchor" id="autotoc_md13490"></a>
VS Code</h2>
<ul>
<li><a href="https://marketplace.visualstudio.com/items?itemName=csstools.postcss"><code>csstools.postcss</code></a> adds support for PostCSS, <code>postcss-preset-env</code> and CSS Modules.</li>
</ul>
<h2><a class="anchor" id="autotoc_md13491"></a>
Atom</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md13492"></a>
Sublime Text</h2>
<ul>
...
<h1><a class="anchor" id="autotoc_md13495"></a>
Security Contact</h1>
...
<h1><a class="anchor" id="autotoc_md13496"></a>
For Enterprise</h1>
