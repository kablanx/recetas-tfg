...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_acorn__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="line">console.log(acorn.parse(&quot;1 + 1&quot;));</div>
...
<p>Options can be provided by passing a second argument, which should be an object containing any of these fields:</p>
<ul>
<li><p class="startli"><b>ecmaVersion</b>: Indicates the ECMAScript version to parse. Must be either 3, 5, 6 (2015), 7 (2016), 8 (2017), 9 (2018) or 10 (2019, partial support). This influences support for strict mode, the set of reserved words, and support for new syntax features. Default is 9.</p>
<p class="startli"><b>NOTE</b>: Only 'stage 4' (finalized) ECMAScript features are being implemented by Acorn. Other proposed new features can be implemented through plugins.</p>
</li>
...
<li><b>allowAwaitOutsideFunction</b>: By default, <code>await</code> expressions can only appear inside <code>async</code> functions. Setting this option to <code>true</code> allows to have top-level <code>await</code> expressions. They are still not allowed in non-<code>async</code> functions, though.</li>
...
<div class="line">JSXParser.parse(&quot;foo(&lt;bar/&gt;)&quot;);</div>
...
<p>The utility spits out the syntax tree as <a class="el" href="class_j_s_o_n.html">JSON</a> data.</p>
...
<ul>
<li><a href="https://github.com/acornjs/acorn-stage3"><code>acorn-stage3</code></a>: Parse most stage 3 proposals, bundling:<ul>
...
<li><a href="https://github.com/acornjs/acorn-private-methods"><code>acorn-private-methods</code></a>: parse <a href="https://github.com/tc39/proposal-private-methods">private methods, getters and setters proposal</a>n </li>
</ul>
</li>
</ul>
</div></div><!-- contents -->
