...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_webpack_node_modules_cacache__r_e_a_d_m_e_8es.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
<div class="PageDoc"><div class="header">
  <div class="headertitle">
<div class="title">cacache <a href="https://npm.im/cacache"><object type="image/svg+xml" data="https://img.shields.io/npm/v/cacache.svg" style="pointer-events: none;">npm version</object></a> <a href="https://npm.im/cacache"><object type="image/svg+xml" data="https://img.shields.io/npm/l/cacache.svg" style="pointer-events: none;">license</object></a> <a href="https://travis-ci.org/zkat/cacache"><object type="image/svg+xml" data="https://img.shields.io/travis/zkat/cacache.svg" style="pointer-events: none;">Travis</object></a> <a href="https://ci.appveyor.com/project/zkat/cacache"><img src="https://ci.appveyor.com/api/projects/status/github/zkat/cacache?svg=true" alt="AppVeyor" class="inline"/></a> <a href="https://coveralls.io/github/zkat/cacache?branch=latest"><object type="image/svg+xml" data="https://coveralls.io/repos/github/zkat/cacache/badge.svg?branch=latest" style="pointer-events: none;">Coverage Status</object></a> </div>  </div>
</div><!--header-->
<div class="contents">
...
<h1><a class="anchor" id="autotoc_md21331"></a>
Instalación</h1>
...
<div class="line">  })</div>
<div class="line">})</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md21334"></a>
Características</h2>
<ul>
...
<p>Por favor refiérase al <a class="el" href="yargs-parser_2_c_h_a_n_g_e_l_o_g_8md.html">Historial de Cambios</a> (en inglés) para detalles sobre cambios importantes incluídos en cada versión.</p>
...
API</h2>
<h3><a class="anchor" id="autotoc_md21337"></a>
...
<h4><a class="anchor" id="autotoc_md21339"></a>
Ejemplo</h4>
<p>```javascript cacache.ls(rutaCache).then(console.log) // Salida { 'my-thing': { key: 'my-thing', integrity: 'sha512-BaSe64/EnCoDED+HAsh==' path: '.testcache/content/deadbeef', // unido con <code>rutaCache</code> time: 12345698490, size: 4023948, metadata: { name: 'blah', version: '1.2.3', description: 'this was once a package but now it is my-thing' } }, 'other-thing': { key: 'other-thing', integrity: 'sha1-ANothER+hasH=', path: '.testcache/content/bada55', time: 11992309289, size: 111112 } } ```</p>
...
<h4><a class="anchor" id="autotoc_md21341"></a>
Ejemplo</h4>
<p>``&lsquo;javascript cacache.ls.flujo(rutaCache).on('data&rsquo;, console.log) // Salida { key: 'my-thing', integrity: 'sha512-BaSe64HaSh', path: '.testcache/content/deadbeef', // unido con <code>rutaCache</code> time: 12345698490, size: 13423, metadata: { name: 'blah', version: '1.2.3', description: 'this was once a package but now it is my-thing' } }</p>
...
<p>{ ... } ```</p>
<h3><a class="anchor" id="autotoc_md21342"></a>
...
<h4><a class="anchor" id="autotoc_md21343"></a>
Nota</h4>
...
<h4><a class="anchor" id="autotoc_md21344"></a>
Ejemplo</h4>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md21345"></a>
...
<h4><a class="anchor" id="autotoc_md21346"></a>
Ejemplo</h4>
<div class="fragment"><div class="line">// Busca por clave</div>
...
<div class="line">  fs.createWriteStream(&#39;./x.tgz&#39;)</div>
<div class="line">)</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md21347"></a>
...
<h4><a class="anchor" id="autotoc_md21348"></a>
Campos</h4>
<ul>
...
<h4><a class="anchor" id="autotoc_md21349"></a>
Ejemplo</h4>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md21350"></a>
...
<h4><a class="anchor" id="autotoc_md21351"></a>
Ejemplo</h4>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md21352"></a>
...
<h4><a class="anchor" id="autotoc_md21353"></a>
Ejemplo</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md21354"></a>
...
<h4><a class="anchor" id="autotoc_md21355"></a>
Ejemplo</h4>
...
<div class="line">)</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md21356"></a>
...
<h4><a class="anchor" id="autotoc_md21359"></a>
...
<h4><a class="anchor" id="autotoc_md21360"></a>
...
<h4><a class="anchor" id="autotoc_md21361"></a>
...
<h4><a class="anchor" id="autotoc_md21362"></a>
...
<h3><a class="anchor" id="autotoc_md21363"></a>
...
<h4><a class="anchor" id="autotoc_md21364"></a>
Ejemplo</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md21365"></a>
...
<h4><a class="anchor" id="autotoc_md21366"></a>
Ejemplo</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md21367"></a>
...
<h4><a class="anchor" id="autotoc_md21368"></a>
Ejemplo</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md21369"></a>
...
<p><em>Te interesa añadir más lenguajes? <a class="el" href="stackframe_2_c_o_n_t_r_i_b_u_t_i_n_g_8md.html">Somete un PR</a>!</em></p>
<h3><a class="anchor" id="autotoc_md21370"></a>
...
<h3><a class="anchor" id="autotoc_md21371"></a>
...
<h4><a class="anchor" id="autotoc_md21372"></a>
Ejemplo</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md21373"></a>
...
<h4><a class="anchor" id="autotoc_md21374"></a>
Ejemplo</h4>
...
<div class="line">})</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md21375"></a>
...
<h4><a class="anchor" id="autotoc_md21376"></a>
...
<h3><a class="anchor" id="autotoc_md21377"></a>
...
<h4><a class="anchor" id="autotoc_md21378"></a>
Opciones</h4>
<ul>
...
<h4><a class="anchor" id="autotoc_md21379"></a>
Example</h4>
...
<h4><a class="anchor" id="autotoc_md21381"></a>
Example</h4>
