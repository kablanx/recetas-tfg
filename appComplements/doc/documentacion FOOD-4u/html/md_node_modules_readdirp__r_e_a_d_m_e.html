...
<title>Food4uDoc: readdirp &lt;a href=&quot;http://travis-ci.org/thlorenz/readdirp&quot;&gt;&lt;img src=&quot;https://secure.travis-ci.org/thlorenz/readdirp.svg&quot; alt=&quot;Build Status&quot;/&gt;&lt;/a&gt;</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_readdirp__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
<div class="PageDoc"><div class="header">
  <div class="headertitle">
<div class="title">readdirp <a href="http://travis-ci.org/thlorenz/readdirp"><object type="image/svg+xml" data="https://secure.travis-ci.org/thlorenz/readdirp.svg" style="pointer-events: none;">Build Status</object></a> </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p><a href="https://nodei.co/npm/readdirp/"><img src="https://nodei.co/npm/readdirp.png?downloads=true&amp;stars=true" alt="NPM" class="inline"/></a></p>
...
<div class="fragment"><div class="line">var readdirp = require(&#39;readdirp&#39;)</div>
<div class="line">  , path = require(&#39;path&#39;)</div>
<div class="line">  , es = require(&#39;event-stream&#39;);</div>
<div class="line"> </div>
<div class="line">// print out all JavaScript files along with their size</div>
<div class="line"> </div>
<div class="line">var stream = readdirp({ root: path.join(__dirname), fileFilter: &#39;*.js&#39; });</div>
<div class="line">stream</div>
<div class="line">  .on(&#39;warn&#39;, function (err) {</div>
<div class="line">    console.error(&#39;non-fatal error&#39;, err);</div>
<div class="line">    // optionally call stream.destroy() here in order to abort and cause &#39;close&#39; to be emitted</div>
<div class="line">  })</div>
<div class="line">  .on(&#39;error&#39;, function (err) { console.error(&#39;fatal error&#39;, err); })</div>
<div class="line">  .pipe(es.mapSync(function (entry) {</div>
<div class="line">    return { path: entry.path, size: entry.stat.size };</div>
<div class="line">  }))</div>
<div class="line">  .pipe(es.stringify())</div>
<div class="line">  .pipe(process.stdout);</div>
</div><!-- fragment --><p>Meant to be one of the recursive versions of <a href="http://nodejs.org/docs/latest/api/fs.html">fs</a> functions, e.g., like <a href="https://github.com/substack/node-mkdirp">mkdirp</a>.</p>
...
<h1><a class="anchor" id="autotoc_md16353"></a>
Installation</h1>
<pre class="fragment">npm install readdirp
</pre><h1><a class="anchor" id="autotoc_md16354"></a>
API</h1>
...
<h2><a class="anchor" id="autotoc_md16355"></a>
entry stream</h2>
...
<h2><a class="anchor" id="autotoc_md16356"></a>
options</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md16357"></a>
entry info</h2>
...
<h2><a class="anchor" id="autotoc_md16358"></a>
Filters</h2>
...
<h2><a class="anchor" id="autotoc_md16359"></a>
Callback API</h2>
...
<h3><a class="anchor" id="autotoc_md16360"></a>
allProcessed</h3>
<ul>
...
<h3><a class="anchor" id="autotoc_md16361"></a>
fileProcessed</h3>
<ul>
<li>function with <a href="#entry-info">entry info</a> parameter e.g., <code>function (entryInfo) { ... }</code></li>
</ul>
<h1><a class="anchor" id="autotoc_md16362"></a>
More Examples</h1>
<p>&lsquo;on('error&rsquo;, ..)<code>,</code>on('warn', ..)<code>and</code>on('end', ..)` handling omitted for brevity</p>
<div class="fragment"><div class="line">var readdirp = require(&#39;readdirp&#39;);</div>
<div class="line"> </div>
<div class="line">// Glob file filter</div>
<div class="line">readdirp({ root: &#39;./test/bed&#39;, fileFilter: &#39;*.js&#39; })</div>
<div class="line">  .on(&#39;data&#39;, function (entry) {</div>
<div class="line">    // do something with each JavaScript file entry</div>
<div class="line">  });</div>
<div class="line"> </div>
<div class="line">// Combined glob file filters</div>
<div class="line">readdirp({ root: &#39;./test/bed&#39;, fileFilter: [ &#39;*.js&#39;, &#39;*.json&#39; ] })</div>
<div class="line">  .on(&#39;data&#39;, function (entry) {</div>
<div class="line">    // do something with each JavaScript and Json file entry</div>
<div class="line">  });</div>
<div class="line"> </div>
<div class="line">// Combined negated directory filters</div>
<div class="line">readdirp({ root: &#39;./test/bed&#39;, directoryFilter: [ &#39;!.git&#39;, &#39;!*modules&#39; ] })</div>
<div class="line">  .on(&#39;data&#39;, function (entry) {</div>
<div class="line">    // do something with each file entry found outside &#39;.git&#39; or any modules directory</div>
<div class="line">  });</div>
<div class="line"> </div>
<div class="line">// Function directory filter</div>
<div class="line">readdirp({ root: &#39;./test/bed&#39;, directoryFilter: function (di) { return di.name.length === 9; } })</div>
<div class="line">  .on(&#39;data&#39;, function (entry) {</div>
<div class="line">    // do something with each file entry found inside directories whose name has length 9</div>
<div class="line">  });</div>
<div class="line"> </div>
<div class="line">// Limiting depth</div>
<div class="line">readdirp({ root: &#39;./test/bed&#39;, depth: 1 })</div>
<div class="line">  .on(&#39;data&#39;, function (entry) {</div>
<div class="line">    // do something with each file entry found up to 1 subdirectory deep</div>
<div class="line">  });</div>
<div class="line"> </div>
<div class="line">// callback api</div>
<div class="line">readdirp({ root: &#39;.&#39; }, function(fileInfo) {</div>
<div class="line">   // do something with file entry here</div>
<div class="line">  }, function (err, res) {</div>
<div class="line">    // all done, move on or do final step for all file entries here</div>
<div class="line">});</div>
</div><!-- fragment --><p>Try more examples by following <a href="https://github.com/paulmillr/readdirp/blob/master/examples/Readme.md">instructions</a> on how to get going.</p>
<h2><a class="anchor" id="autotoc_md16363"></a>
tests</h2>
