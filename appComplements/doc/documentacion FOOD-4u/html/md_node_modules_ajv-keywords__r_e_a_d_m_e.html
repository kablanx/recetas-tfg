...
<title>Food4uDoc: ajv-keywords</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_ajv-keywords__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<p><a href="https://travis-ci.org/epoberezkin/ajv-keywords"><object type="image/svg+xml" data="https://travis-ci.org/epoberezkin/ajv-keywords.svg?branch=master" style="pointer-events: none;">Build Status</object></a> <a href="https://www.npmjs.com/package/ajv-keywords"><object type="image/svg+xml" data="https://img.shields.io/npm/v/ajv-keywords.svg" style="pointer-events: none;">npm</object></a> <a href="https://www.npmjs.com/package/ajv-keywords"><object type="image/svg+xml" data="https://img.shields.io/npm/dm/ajv-keywords.svg" style="pointer-events: none;">npm downloads</object></a> <a href="https://coveralls.io/github/epoberezkin/ajv-keywords?branch=master"><object type="image/svg+xml" data="https://coveralls.io/repos/github/epoberezkin/ajv-keywords/badge.svg?branch=master" style="pointer-events: none;">Coverage Status</object></a> <a href="https://greenkeeper.io/"><object type="image/svg+xml" data="https://badges.greenkeeper.io/epoberezkin/ajv-keywords.svg" style="pointer-events: none;">Greenkeeper badge</object></a> <a href="https://gitter.im/ajv-validator/ajv"><object type="image/svg+xml" data="https://img.shields.io/gitter/room/ajv-validator/ajv.svg" style="pointer-events: none;">Gitter</object></a></p>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md1125"></a>
...
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md1129"></a>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md1135"></a>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md1136"></a>
...
<p>This keyword allows to validate deep properties (identified by <a class="el" href="class_j_s_o_n.html">JSON</a> pointers).</p>
<p>This keyword applies only to objects. If the data is not an object, the validation succeeds.</p>
<p>The value should be an object, where keys are <a class="el" href="class_j_s_o_n.html">JSON</a> pointers to the data, starting from the current position in data, and the values are <a class="el" href="class_j_s_o_n.html">JSON</a> schemas. For data object to be valid the value of each <a class="el" href="class_j_s_o_n.html">JSON</a> pointer should be valid according to the corresponding schema.</p>
<div class="fragment"><div class="line">var schema = {</div>
<div class="line">  type: &#39;object&#39;,</div>
...
<div class="line">  }</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md1140"></a>
&lt;tt&gt;deepRequired&lt;/tt&gt;</h3>
<p>This keyword allows to check that some deep properties (identified by <a class="el" href="class_j_s_o_n.html">JSON</a> pointers) are available.</p>
<p>This keyword applies only to objects. If the data is not an object, the validation succeeds.</p>
<p>The value should be an array of <a class="el" href="class_j_s_o_n.html">JSON</a> pointers to the data, starting from the current position in data. For data object to be valid each <a class="el" href="class_j_s_o_n.html">JSON</a> pointer should be some existing part of the data.</p>
<div class="fragment"><div class="line">var schema = {</div>
<div class="line">  type: &#39;object&#39;,</div>
...
<p><b>Please note</b>: this keyword is provided to preserve backward compatibility with previous versions of Ajv. It is strongly recommended to use <code>if</code>/<code>then</code>/<code>else</code> keywords instead, as they have been added to the draft-07 of <a class="el" href="class_j_s_o_n.html">JSON</a> Schema specification.</p>
...
<p>The value of <code>select</code> keyword should be a <a href="https://github.com/epoberezkin/ajv/tree/5.0.2-beta.0#data-reference">$data reference</a> that points to any primitive <a class="el" href="class_j_s_o_n.html">JSON</a> type (string, number, boolean or null) in the data that is validated. You can also use a constant of primitive type as the value of this keyword (e.g., for debugging purposes).</p>
