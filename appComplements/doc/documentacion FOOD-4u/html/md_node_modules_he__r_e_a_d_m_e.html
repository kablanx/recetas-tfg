...
<title>Food4uDoc: he &lt;a href=&quot;https://travis-ci.org/mathiasbynens/he&quot;&gt;&lt;img src=&quot;https://travis-ci.org/mathiasbynens/he.svg?branch=master&quot; alt=&quot;Build status&quot;/&gt;&lt;/a&gt; &lt;a href=&quot;https://codecov.io/github/mathiasbynens/he?branch=master&quot;&gt;&lt;img src=&quot;https://codecov.io/github/mathiasbynens/he/coverage.svg?branch=master&quot; alt=&quot;Code coverage status&quot;/&gt;&lt;/a&gt; &lt;a href=&quot;https://gemnasium.com/mathiasbynens/he&quot;&gt;&lt;img src=&quot;https://gemnasium.com/mathiasbynens/he.svg&quot; alt=&quot;Dependency status&quot;/&gt;&lt;/a&gt;</title>
...
<div class="title">he <a href="https://travis-ci.org/mathiasbynens/he"><object type="image/svg+xml" data="https://travis-ci.org/mathiasbynens/he.svg?branch=master" style="pointer-events: none;">Build status</object></a> <a href="https://codecov.io/github/mathiasbynens/he?branch=master"><object type="image/svg+xml" data="https://codecov.io/github/mathiasbynens/he/coverage.svg?branch=master" style="pointer-events: none;">Code coverage status</object></a> <a href="https://gemnasium.com/mathiasbynens/he"><object type="image/svg+xml" data="https://gemnasium.com/mathiasbynens/he.svg" style="pointer-events: none;">Dependency status</object></a> </div>  </div>
</div><!--header-->
<div class="contents">
...
<h1><a class="anchor" id="autotoc_md8864"></a>
Installation</h1>
...
<div class="line">  }</div>
<div class="line">);</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md8865"></a>
API</h1>
<h2><a class="anchor" id="autotoc_md8866"></a>
&lt;tt&gt;he.version&lt;/tt&gt;</h2>
<p>A string representing the semantic version number.</p>
<h2><a class="anchor" id="autotoc_md8867"></a>
...
<div class="fragment"><div class="line">he.encode(&#39;foo © bar ≠ baz 𝌆 qux&#39;);</div>
<div class="line">// → &#39;foo &amp;#xA9; bar &amp;#x2260; baz &amp;#x1D306; qux&#39;</div>
...
<h3><a class="anchor" id="autotoc_md8868"></a>
...
<div class="line">he.encode(&#39;foo © bar ≠ baz 𝌆 qux&#39;);</div>
<div class="line">// → &#39;foo &amp;#xA9; bar &amp;#x2260; baz &amp;#x1D306; qux&#39;</div>
<div class="line"> </div>
...
<div class="line">});</div>
<div class="line">// → &#39;foo &amp;copy; bar &amp;ne; baz &amp;#x1D306; qux&#39;</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8869"></a>
&lt;tt&gt;decimal&lt;/tt&gt;</h3>
...
<div class="line">});</div>
<div class="line">// → &#39;foo &amp;copy; bar &amp;ne; baz &amp;#119558; qux&#39;</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8870"></a>
...
<div class="line">});</div>
<div class="line">// → &#39;&amp;#x66;&amp;#x6F;&amp;#x6F;&amp;#x20;&amp;copy;&amp;#x20;&amp;#x62;&amp;#x61;&amp;#x72;&amp;#x20;&amp;ne;&amp;#x20;&amp;#x62;&amp;#x61;&amp;#x7A;&amp;#x20;&amp;#x1D306;&amp;#x20;&amp;#x71;&amp;#x75;&amp;#x78;&#39;</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8871"></a>
&lt;tt&gt;strict&lt;/tt&gt;</h3>
...
<div class="line">});</div>
<div class="line">// → Parse error</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8872"></a>
...
<div class="line">});</div>
<div class="line">// → &#39;foo &amp;#xA9; and &amp; ampersand&#39;</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8873"></a>
...
<div class="line">he.encode(&#39;foo © bar ≠ baz 𝌆 qux&#39;);</div>
<div class="line">// → &#39;foo &amp;copy; bar &amp;ne; baz &amp;#x1D306; qux&#39;</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md8874"></a>
...
<h3><a class="anchor" id="autotoc_md8875"></a>
...
<div class="line">});</div>
<div class="line">// → &#39;foo&amp;ampbar&#39;</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8876"></a>
&lt;tt&gt;strict&lt;/tt&gt;</h3>
...
<div class="line">});</div>
<div class="line">// → Parse error</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8877"></a>
...
<div class="line">he.decode(&#39;foo&amp;ampbar&#39;);</div>
<div class="line">// → &#39;foo&amp;ampbar&#39;</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md8878"></a>
...
<div class="line">// → &#39;&amp;lt;img src=&amp;#x27;x&amp;#x27; onerror=&amp;quot;prompt(1)&amp;quot;&amp;gt;&#39;</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md8879"></a>
...
<h2><a class="anchor" id="autotoc_md8880"></a>
...
<div class="fragment"><div class="line">$ he --encode &#39;föo ♥ bår 𝌆 baz&#39;</div>
<div class="line">f&amp;#xF6;o &amp;#x2665; b&amp;#xE5;r &amp;#x1D306; baz</div>
<div class="line"> </div>
<div class="line">$ he --encode --use-named-refs &#39;föo ♥ bår 𝌆 baz&#39;</div>
...
</div><!-- fragment --><p>Or, the opposite — read a local file containing a snippet of HTML in a text context, decode it back to plain text, and save the result to a new file:</p>
...
<h1><a class="anchor" id="autotoc_md8881"></a>
Support</h1>
...
<h1><a class="anchor" id="autotoc_md8882"></a>
...
<h1><a class="anchor" id="autotoc_md8883"></a>
Acknowledgements</h1>
...
<h1><a class="anchor" id="autotoc_md8884"></a>
Author</h1>
...
<h1><a class="anchor" id="autotoc_md8885"></a>
License</h1>
