...
<title>Food4uDoc: compression</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_compression__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="contents">
<div class="textblock"><p><a href="https://npmjs.org/package/compression"><object type="image/svg+xml" data="https://img.shields.io/npm/v/compression.svg" style="pointer-events: none;">NPM Version</object></a> <a href="https://npmjs.org/package/compression"><object type="image/svg+xml" data="https://img.shields.io/npm/dm/compression.svg" style="pointer-events: none;">NPM Downloads</object></a> <a href="https://travis-ci.org/expressjs/compression"><object type="image/svg+xml" data="https://img.shields.io/travis/expressjs/compression/master.svg" style="pointer-events: none;">Build Status</object></a> <a href="https://coveralls.io/r/expressjs/compression?branch=master"><object type="image/svg+xml" data="https://img.shields.io/coveralls/expressjs/compression/master.svg" style="pointer-events: none;">Test Coverage</object></a></p>
...
<h1><a class="anchor" id="autotoc_md4206"></a>
Install</h1>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md4207"></a>
API</h1>
<div class="fragment"><div class="line">var compression = require(&#39;compression&#39;)</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md4208"></a>
...
<h4><a class="anchor" id="autotoc_md4212"></a>
level</h4>
...
<h4><a class="anchor" id="autotoc_md4213"></a>
memLevel</h4>
...
<p>See <a href="http://nodejs.org/api/zlib.html#zlib_memory_usage_tuning">Node.js documentation</a> regarding the usage.</p>
<h4><a class="anchor" id="autotoc_md4214"></a>
strategy</h4>
...
<p><b>Note</b> in the list above, <code>zlib</code> is from &lsquo;zlib = require('zlib&rsquo;)`.</p>
<h4><a class="anchor" id="autotoc_md4215"></a>
threshold</h4>
<p>The byte threshold for the response body size before compression is considered for the response, defaults to <code>1kb</code>. This is a number of bytes or any string accepted by the <a href="https://www.npmjs.com/package/bytes">bytes</a> module.</p>
...
<div class="line">  })</div>
<div class="line">})</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md4222"></a>
License</h1>
<p>[MIT](LICENSE) </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
