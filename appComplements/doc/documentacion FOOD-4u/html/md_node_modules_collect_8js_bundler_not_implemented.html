...
<title>Food4uDoc: Methods that have not been implemented:</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_collect_8js_bundler_not_implemented.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
<div class="PageDoc"><div class="header">
  <div class="headertitle">
<div class="title">Methods that have not been implemented: </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><ul>
<li>~~<code>containsStrict</code>~~ use <code>contains()</code></li>
<li>~~<code>duplicatesStrict</code>~~ use <code>duplicates()</code></li>
