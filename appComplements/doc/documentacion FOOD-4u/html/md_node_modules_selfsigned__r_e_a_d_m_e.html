...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_selfsigned__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md17425"></a>
Attributes</h2>
<p>for attributes, please refer to: <a href="https://github.com/digitalbazaar/forge/blob/0.7.5/lib/x509.js#L129">https://github.com/digitalbazaar/forge/blob/0.7.5/lib/x509.js#L129</a></p>
<h2><a class="anchor" id="autotoc_md17426"></a>
Options</h2>
<div class="fragment"><div class="line">var pems = selfsigned.generate(null, {</div>
<div class="line">  keySize: 2048, // the size for the private key in bits (default: 1024)</div>
<div class="line">  days: 30, // how long till expiry of the signed certificate (default: 365)</div>
<div class="line">  algorithm: &#39;sha256&#39;, // sign the certificate with specified algorithm (default: &#39;sha1&#39;)</div>
<div class="line">  extensions: [{ name: &#39;basicConstraints&#39;, cA: true }], // certificate extensions array</div>
<div class="line">  pkcs7: true, // include PKCS#7 as part of the output (default: false)</div>
<div class="line">  clientCertificate: true, // generate client cert signed by the original key (default: false)</div>
<div class="line">  clientCertificateCN: &#39;jdoe&#39; // client certificate&#39;s common name (default: &#39;John Doe jdoe123&#39;)</div>
<div class="line">});</div>
</div><!-- fragment --><blockquote class="doxtable">
<p>You can avoid key pair generation specifying your own keys (&lsquo;{ keyPair: { publicKey: &rsquo;--&mdash;BEGIN PUBLIC KEY--&mdash;...', privateKey: '--&mdash;BEGIN RSA PRIVATE KEY--&mdash;...' }`) </p>
</blockquote>
<h3><a class="anchor" id="autotoc_md17427"></a>
Generate Client Certificates</h3>
