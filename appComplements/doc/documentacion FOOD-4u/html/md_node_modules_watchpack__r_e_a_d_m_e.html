...
<title>Food4uDoc: watchpack</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_watchpack__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
<div class="PageDoc"><div class="header">
  <div class="headertitle">
<div class="title">watchpack </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p>Wrapper library for directory and file watching.</p>
<p><a href="https://travis-ci.org/webpack/watchpack"><object type="image/svg+xml" data="https://travis-ci.org/webpack/watchpack.svg?branch=master" style="pointer-events: none;">Build Status</object></a> <a href="https://ci.appveyor.com/project/sokra/watchpack/branch/master"><img src="https://ci.appveyor.com/api/projects/status/e5u2qvmugtv0r647/branch/master?svg=true" alt="Build status" class="inline"/></a> <a href="https://coveralls.io/r/webpack/watchpack/"><object type="image/svg+xml" data="https://img.shields.io/coveralls/webpack/watchpack.svg" style="pointer-events: none;">Test coverage</object></a></p>
<h1><a class="anchor" id="autotoc_md21218"></a>
Concept</h1>
...
<h1><a class="anchor" id="autotoc_md21219"></a>
API</h1>
...
<div class="line"> </div>
<div class="line">    ignored: /node_modules/,</div>
<div class="line">    // anymatch-compatible definition of files/paths to be ignored</div>
<div class="line">    // see https://github.com/paulmillr/chokidar#path-filtering</div>
<div class="line">});</div>
<div class="line"> </div>
<div class="line">// Watchpack.prototype.watch(string[] files, string[] directories, [number startTime])</div>
<div class="line">wp.watch(listOfFiles, listOfDirectories, Date.now() - 10000);</div>
...
<div class="line"> </div>
<div class="line">wp.on(&quot;change&quot;, function(filePath, mtime) {</div>
<div class="line">    // filePath: the changed file</div>
<div class="line">    // mtime: last modified time for the changed file</div>
<div class="line">});</div>
<div class="line"> </div>
<div class="line">wp.on(&quot;aggregated&quot;, function(changes) {</div>
<div class="line">    // changes: an array of all changed files</div>
<div class="line">});</div>
<div class="line"> </div>
...
<div class="line">// returns an object with all know change times for files</div>
