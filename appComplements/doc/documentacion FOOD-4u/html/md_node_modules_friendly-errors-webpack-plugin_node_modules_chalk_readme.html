...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_friendly-errors-webpack-plugin_node_modules_chalk_readme.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="textblock"><h1 align="center"><br  />
 <br  />
 <object type="image/svg+xml" data="https://cdn.rawgit.com/chalk/chalk/19935d6484811c5e468817f846b7b3d417d7bf4a/logo.svg" style="pointer-events: none;" width="360">chalk</object> <br  />
 <br  />
 <br  />
 </h1>
...
<p><a href="https://travis-ci.org/chalk/chalk"><object type="image/svg+xml" data="https://travis-ci.org/chalk/chalk.svg?branch=master" style="pointer-events: none;">Build Status</object></a> <a href="https://coveralls.io/r/chalk/chalk?branch=master"><object type="image/svg+xml" data="https://coveralls.io/repos/chalk/chalk/badge.svg?branch=master" style="pointer-events: none;">Coverage Status</object></a> <a href="https://www.youtube.com/watch?v=9auOCbH5Ns4"><object type="image/svg+xml" data="http://img.shields.io/badge/unicorn-approved-ff69b4.svg" style="pointer-events: none;"></object></a></p>
...
<p><img src="https://github.com/chalk/ansi-styles/raw/master/screenshot.png" alt="" class="inline"/></p>
<h2><a class="anchor" id="autotoc_md8308"></a>
Why</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md8309"></a>
Install</h2>
<div class="fragment"><div class="line">$ npm install --save chalk</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md8310"></a>
Usage</h2>
<p>Chalk comes with an easy to use composable API where you just chain and nest the styles you want.</p>
<div class="fragment"><div class="line">var chalk = require(&#39;chalk&#39;);</div>
<div class="line"> </div>
<div class="line">// style a string</div>
<div class="line">chalk.blue(&#39;Hello world!&#39;);</div>
<div class="line"> </div>
<div class="line">// combine styled and normal strings</div>
<div class="line">chalk.blue(&#39;Hello&#39;) + &#39;World&#39; + chalk.red(&#39;!&#39;);</div>
<div class="line"> </div>
<div class="line">// compose multiple styles using the chainable API</div>
<div class="line">chalk.blue.bgRed.bold(&#39;Hello world!&#39;);</div>
<div class="line"> </div>
<div class="line">// pass in multiple arguments</div>
<div class="line">chalk.blue(&#39;Hello&#39;, &#39;World!&#39;, &#39;Foo&#39;, &#39;bar&#39;, &#39;biz&#39;, &#39;baz&#39;);</div>
<div class="line"> </div>
<div class="line">// nest styles</div>
<div class="line">chalk.red(&#39;Hello&#39;, chalk.underline.bgBlue(&#39;world&#39;) + &#39;!&#39;);</div>
<div class="line"> </div>
<div class="line">// nest styles of the same type even (color, underline, background)</div>
<div class="line">chalk.green(</div>
...
<div class="fragment"><div class="line">var chalk = require(&#39;chalk&#39;);</div>
<div class="line">var error = chalk.bold.red;</div>
<div class="line">console.log(error(&#39;Error!&#39;));</div>
</div><!-- fragment --><p>Take advantage of console.log <a href="http://nodejs.org/docs/latest/api/console.html#console_console_log_data">string substitution</a>.</p>
<div class="fragment"><div class="line">var name = &#39;Sindre&#39;;</div>
<div class="line">console.log(chalk.green(&#39;Hello %s&#39;), name);</div>
<div class="line">//=&gt; Hello Sindre</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md8311"></a>
API</h2>
<h3><a class="anchor" id="autotoc_md8312"></a>
...
<h3><a class="anchor" id="autotoc_md8313"></a>
chalk.enabled</h3>
...
<div class="fragment"><div class="line">var ctx = new chalk.constructor({enabled: false});</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8314"></a>
...
<h3><a class="anchor" id="autotoc_md8315"></a>
chalk.styles</h3>
...
<div class="fragment"><div class="line">var chalk = require(&#39;chalk&#39;);</div>
<div class="line"> </div>
<div class="line">console.log(chalk.styles.red);</div>
<div class="line">//=&gt; {open: &#39;\u001b[31m&#39;, close: &#39;\u001b[39m&#39;}</div>
<div class="line"> </div>
<div class="line">console.log(chalk.styles.red.open + &#39;Hello&#39; + chalk.styles.red.close);</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md8316"></a>
chalk.hasColor(string)</h3>
<p>Check whether a string <a href="https://github.com/chalk/has-ansi">has color</a>.</p>
<h3><a class="anchor" id="autotoc_md8317"></a>
chalk.stripColor(string)</h3>
...
<p>Example:</p>
<div class="fragment"><div class="line">var chalk = require(&#39;chalk&#39;);</div>
<div class="line">var styledString = getText();</div>
<div class="line"> </div>
<div class="line">if (!chalk.supportsColor) {</div>
<div class="line">    styledString = chalk.stripColor(styledString);</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md8318"></a>
Styles</h2>
<h3><a class="anchor" id="autotoc_md8319"></a>
Modifiers</h3>
<ul>
...
<h3><a class="anchor" id="autotoc_md8320"></a>
Colors</h3>
<ul>
...
<h3><a class="anchor" id="autotoc_md8321"></a>
...
<h2><a class="anchor" id="autotoc_md8322"></a>
256-colors</h2>
...
<h2><a class="anchor" id="autotoc_md8323"></a>
Windows</h2>
...
<h2><a class="anchor" id="autotoc_md8324"></a>
Related</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md8325"></a>
License</h2>
