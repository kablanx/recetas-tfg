...
<title>Food4uDoc: Persistent references</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_nan_doc_persistent.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<h2><a class="anchor" id="autotoc_md11788"></a>
...
<h2><a class="anchor" id="autotoc_md11789"></a>
...
<h2><a class="anchor" id="autotoc_md11790"></a>
...
<h2><a class="anchor" id="autotoc_md11791"></a>
Nan::Persistent</h2>
...
<h2><a class="anchor" id="autotoc_md11792"></a>
Nan::Global</h2>
...
<h2><a class="anchor" id="autotoc_md11793"></a>
...
<h2><a class="anchor" id="autotoc_md11794"></a>
Nan::WeakCallbackType</h2>
<p>Represents the type of a weak callback. A weak callback of type <code>kParameter</code> makes the supplied parameter to <code>Nan::PersistentBase::SetWeak</code> available through <code><a class="el" href="class_weak_callback_info.html#a1d005d85d3de387fcab96651715aeb5f">WeakCallbackInfo::GetParameter</a></code>. A weak callback of type <code>kInternalFields</code> uses up to two internal fields at indices 0 and 1 on the <code><a class="el" href="class_nan_1_1_persistent_base.html">Nan::PersistentBase</a>&lt;v8::Object&gt;</code> being made weak. Note that only <code>v8::Object</code>s and derivatives can have internal fields.</p>
<p>Definition:</p>
<div class="fragment"><div class="line"> {c++}</div>
