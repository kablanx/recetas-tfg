...
<title>Food4uDoc: http-proxy-middleware</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_http-proxy-middleware__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="contents">
<div class="textblock"><p><a href="https://travis-ci.org/chimurai/http-proxy-middleware"><object type="image/svg+xml" data="https://img.shields.io/travis/chimurai/http-proxy-middleware/master.svg?style=flat-square" style="pointer-events: none;">Build Status</object></a> <a href="https://coveralls.io/r/chimurai/http-proxy-middleware"><object type="image/svg+xml" data="https://img.shields.io/coveralls/chimurai/http-proxy-middleware.svg?style=flat-square" style="pointer-events: none;">Coveralls</object></a> <a href="https://david-dm.org/chimurai/http-proxy-middleware#info=dependencies"><object type="image/svg+xml" data="https://img.shields.io/david/chimurai/http-proxy-middleware.svg?style=flat-square" style="pointer-events: none;">dependency Status</object></a> <a href="https://snyk.io/test/npm/http-proxy-middleware"><object type="image/svg+xml" data="https://snyk.io/test/npm/http-proxy-middleware/badge.svg" style="pointer-events: none;">dependency Status</object></a> <a href="https://github.com/prettier/prettier"><object type="image/svg+xml" data="https://img.shields.io/badge/code_style-prettier-ff69b4.svg?style=flat-square" style="pointer-events: none;">code style: prettier</object></a></p>
...
<p>Powered by the popular Nodejitsu <a href="https://github.com/nodejitsu/node-http-proxy"><code>http-proxy</code></a>. <a href="https://github.com/nodejitsu/node-http-proxy"><object type="image/svg+xml" data="https://img.shields.io/github/stars/nodejitsu/node-http-proxy.svg?style=social&amp;label=Star" style="pointer-events: none;">GitHub stars</object></a></p>
<h1><a class="anchor" id="autotoc_md9344"></a>
TL;DR</h1>
...
<h1><a class="anchor" id="autotoc_md9345"></a>
...
<h1><a class="anchor" id="autotoc_md9346"></a>
Install</h1>
<div class="fragment"><div class="line">$ npm install --save-dev http-proxy-middleware</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md9347"></a>
Core concept</h1>
<p>Proxy middleware configuration.</p>
<h3><a class="anchor" id="autotoc_md9348"></a>
...
<h3><a class="anchor" id="autotoc_md9349"></a>
proxy(uri [, config])</h3>
...
<h1><a class="anchor" id="autotoc_md9350"></a>
Example</h1>
...
<div class="line">app.listen(3000)</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md9351"></a>
Context matching</h1>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md9352"></a>
Options</h1>
<h2><a class="anchor" id="autotoc_md9353"></a>
...
<h2><a class="anchor" id="autotoc_md9354"></a>
...
<h2><a class="anchor" id="autotoc_md9355"></a>
...
<div class="line"> </div>
<div class="line">};</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md9356"></a>
Shorthand</h1>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md9357"></a>
...
<h1><a class="anchor" id="autotoc_md9358"></a>
WebSocket</h1>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md9359"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md9360"></a>
Working examples</h1>
...
<h1><a class="anchor" id="autotoc_md9363"></a>
Tests</h1>
