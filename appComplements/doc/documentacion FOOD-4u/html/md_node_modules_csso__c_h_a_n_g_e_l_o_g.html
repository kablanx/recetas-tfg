...
<title>Food4uDoc: 4.0.3 (March 24, 2020)</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_csso__c_h_a_n_g_e_l_o_g.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
<div class="PageDoc"><div class="header">
  <div class="headertitle">
<div class="title">4.0.3 (March 24, 2020) </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><ul>
<li>Prevented percent sign removal in <code>flex</code>/<code>-ms-flex</code> (#410)</li>
<li>Fixed restructuring optimisation in some cases (@charlessuh &amp; @chsuh, #358, #411)</li>
<li>Bumped dependencies (@AviVahl, #409)</li>
</ul>
<h1><a class="anchor" id="autotoc_md5454"></a>
4.0.2 (October 28, 2019)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5455"></a>
4.0.1 (October 22, 2019)</h1>
<ul>
<li>Bumped CSSTree to <a href="https://github.com/csstree/csstree/releases/tag/v1.0.0-alpha.37"><code>1.0.0-alpha.37</code></a> to avoid source map generation inconsistency across Node.js versions</li>
</ul>
<h1><a class="anchor" id="autotoc_md5456"></a>
4.0.0 (October 21, 2019)</h1>
<ul>
<li>Dropped support for Node.js &lt; 8</li>
<li>Refreshed dev dependencies and scripts</li>
<li>Bumped <a href="https://github.com/csstree/csstree">CSSTree</a> to <code>1.0.0-alpha.36</code> (#399)</li>
<li>Changed bundle files: <code>dist/csso.js</code> and <code>dist/csso.min.js</code> instead single <code>dist/csso-browser.js</code> (min version)</li>
<li>Expose <code>compress()</code> as <code>syntax.compress()</code></li>
</ul>
<h1><a class="anchor" id="autotoc_md5457"></a>
3.5.1 (June 7, 2018)</h1>
<ul>
<li>Bumped <a href="https://github.com/csstree/csstree">CSSTree</a> to <code>1.0.0-alpha.29</code> (fixes some issues)</li>
</ul>
<h1><a class="anchor" id="autotoc_md5458"></a>
3.5.0 (January 14, 2018)</h1>
<ul>
<li>Migrated to <a href="https://github.com/csstree/csstree">CSSTree</a> <code>1.0.0-alpha.27</code></li>
</ul>
<h1><a class="anchor" id="autotoc_md5459"></a>
3.4.0 (November 3, 2017)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5460"></a>
3.3.1 (October 17, 2017)</h1>
<ul>
<li>Fixed merge of <code>position</code> declarations when <code>sticky</code> fallback is using (@gruzzilkin, #356)</li>
</ul>
<h1><a class="anchor" id="autotoc_md5461"></a>
3.3.0 (October 12, 2017)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5462"></a>
3.2.0 (September 10, 2017)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5463"></a>
3.1.1 (April 25, 2017)</h1>
<ul>
<li>Fixed crash on a number processing when it used not in a list (#335)</li>
</ul>
<h1><a class="anchor" id="autotoc_md5464"></a>
3.1.0 (April 24, 2017)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5465"></a>
3.0.1 (March 14, 2017)</h1>
<ul>
<li>Fixed declaration merging when declaration contains an <code>!important</code></li>
</ul>
<h1><a class="anchor" id="autotoc_md5466"></a>
3.0.0 (March 13, 2017)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5467"></a>
2.3.1 (January 6, 2017)</h1>
<ul>
<li>Added <code>\0</code> IE hack support (#320)</li>
</ul>
<h1><a class="anchor" id="autotoc_md5468"></a>
2.3.0 (October 25, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5469"></a>
2.2.1 (July 25, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5470"></a>
2.2.0 (June 23, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5471"></a>
2.1.1 (May 11, 2016)</h1>
<ul>
<li>Fix wrong declaration with <code>\9</code> hack merge (#295)</li>
</ul>
<h1><a class="anchor" id="autotoc_md5472"></a>
2.1.0 (May 8, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5473"></a>
2.0.0 (April 5, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5474"></a>
1.8.1 (March 30, 2016)</h1>
<ul>
<li>Don't remove spaces after function/braces/urls since unsafe (#289)</li>
</ul>
<h1><a class="anchor" id="autotoc_md5475"></a>
1.8.0 (March 24, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5476"></a>
1.7.1 (March 16, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5477"></a>
1.7.0 (March 10, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5478"></a>
1.6.4 (March 1, 2016)</h1>
<ul>
<li><code>npm</code> publish issue (#276)</li>
</ul>
<h1><a class="anchor" id="autotoc_md5479"></a>
1.6.3 (February 29, 2016)</h1>
<ul>
<li>add <code>file</code> to generated source map since other tools can relay on it in source map transform chain</li>
</ul>
<h1><a class="anchor" id="autotoc_md5480"></a>
1.6.2 (February 29, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5481"></a>
1.6.1 (February 28, 2016)</h1>
<ul>
<li>fix exception on zero length dimension compress outside declaration (#273)</li>
</ul>
<h1><a class="anchor" id="autotoc_md5482"></a>
1.6.0 (February 27, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5483"></a>
1.5.4 (January 27, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5484"></a>
1.5.3 (January 25, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5485"></a>
1.5.2 (January 24, 2016)</h1>
<ul>
<li>don't merge rulesets if between them a ruleset with same specificity (#264)</li>
</ul>
<h1><a class="anchor" id="autotoc_md5486"></a>
1.5.1 (January 14, 2016)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5487"></a>
1.5.0 (January 14, 2016)</h1>
<h2><a class="anchor" id="autotoc_md5488"></a>
Parser</h2>
<ul>
<li>attach minus to number</li>
</ul>
<h2><a class="anchor" id="autotoc_md5489"></a>
Compressor</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md5490"></a>
API</h2>
<ul>
<li>walker for <code>gonzales</code> AST was implemented</li>
</ul>
<h2><a class="anchor" id="autotoc_md5491"></a>
CLI</h2>
<ul>
...
<h1><a class="anchor" id="autotoc_md5492"></a>
1.4.4 (December 10, 2015)</h1>
<ul>
<li>prevent removal of spaces after braces that before identifier that breaking at-rules expressions (#258)</li>
</ul>
<h1><a class="anchor" id="autotoc_md5493"></a>
1.4.3 (December 4, 2015)</h1>
<ul>
<li>fix unicode-range parsing that cause to wrong function detection (#250)</li>
</ul>
<h1><a class="anchor" id="autotoc_md5494"></a>
1.4.2 (November 9, 2015)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5495"></a>
1.4.1 (October 20, 2015)</h1>
<ul>
...
<h2><a class="anchor" id="autotoc_md5498"></a>
API</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md5499"></a>
CLI</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md5500"></a>
Parsing and optimizations</h2>
<ul>
...
<h1><a class="anchor" id="autotoc_md5501"></a>
1.3.12 (October 8, 2015)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5502"></a>
1.3.7 (February 11, 2013)</h1>
<ul>
<li>Gonzales 1.0.7.</li>
</ul>
<h1><a class="anchor" id="autotoc_md5503"></a>
1.3.6 (November 26, 2012)</h1>
<ul>
<li>Gonzales 1.0.6.</li>
</ul>
<h1><a class="anchor" id="autotoc_md5504"></a>
1.3.5 (October 28, 2012)</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md5505"></a>
1.3.4 (October 10, 2012)</h1>
<ul>
<li></li>
</ul>
</div></div><!-- contents -->
