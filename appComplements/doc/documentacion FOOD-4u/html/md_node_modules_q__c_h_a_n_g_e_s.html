...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_q__c_h_a_n_g_e_s.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<h1><a class="anchor" id="autotoc_md16068"></a>
1.5.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16069"></a>
1.4.1</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16070"></a>
1.4.0</h1>
<ul>
<li>Add <code>noConflict</code> support for use in <code>&lt;script&gt;</code> (@jahnjw).</li>
</ul>
<h1><a class="anchor" id="autotoc_md16071"></a>
1.3.0</h1>
<ul>
<li>Add tracking for unhandled and handled rejections in Node.js (@benjamingr).</li>
</ul>
<h1><a class="anchor" id="autotoc_md16072"></a>
1.2.1</h1>
<ul>
<li>Fix Node.js environment detection for modern Browserify (@kahnjw).</li>
</ul>
<h1><a class="anchor" id="autotoc_md16073"></a>
1.2.0</h1>
<ul>
<li>Added Q.any(promisesArray) method (@vergara). Returns a promise fulfilled with the value of the first resolved promise in promisesArray. If all promises in promisesArray are rejected, it returns a rejected promise.</li>
</ul>
<h1><a class="anchor" id="autotoc_md16074"></a>
1.1.2</h1>
<ul>
<li>Removed extraneous files from the npm package by using the "files" whitelist in package.json instead of the .npmignore blacklist. (@anton-rudeshko)</li>
</ul>
<h1><a class="anchor" id="autotoc_md16075"></a>
1.1.1</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16076"></a>
1.1.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16077"></a>
1.0.1</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16078"></a>
1.0.0</h1>
...
<h1><a class="anchor" id="autotoc_md16079"></a>
0.9.7</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16080"></a>
0.9.6</h1>
<ul>
...
<li>Refactors <code>nextTick</code> to use an unrolled microtask within Q regardless of how new ticks a requested. #316 @rkatic</li>
</ul>
<h1><a class="anchor" id="autotoc_md16081"></a>
0.9.5</h1>
<ul>
...
<li>Introduces <code>spawn</code> for an immediately invoked asychronous generator. @jlongster</li>
...
<h1><a class="anchor" id="autotoc_md16082"></a>
0.9.4</h1>
<ul>
<li><code>isPromise</code> and <code>isPromiseAlike</code> now always returns a boolean (even for falsy values). #284 @lfac-pt</li>
...
<li>Unhandled rejection API #296 @domenic <code>stopUnhandledRejectionTracking</code>, <code>getUnhandledReasons</code>, <code>resetUnhandledRejections</code>.</li>
</ul>
<h1><a class="anchor" id="autotoc_md16083"></a>
0.9.3</h1>
<ul>
<li>Add the ability to give <code>Q.timeout</code>'s errors a custom error message. #270 @jgrenon</li>
...
<h1><a class="anchor" id="autotoc_md16084"></a>
0.9.2</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16085"></a>
0.9.1</h1>
<ul>
<li>Made the AMD detection compatible with the RequireJS optimizer's <code>namespace</code> option. #225 @terinjokes</li>
<li>Fix side effects from <code>valueOf</code>, and thus from <code>isFulfilled</code>, <code>isRejected</code>, and <code>isPending</code>. #226 @benjamn</li>
</ul>
<h1><a class="anchor" id="autotoc_md16086"></a>
0.9.0</h1>
...
<h2><a class="anchor" id="autotoc_md16087"></a>
API Cleanup</h2>
...
<h2><a class="anchor" id="autotoc_md16088"></a>
Alignment with the Concurrency Strawman</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md16089"></a>
Error Handling</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md16090"></a>
Other</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md16091"></a>
Bug Fixes</h2>
<ul>
...
<li><code>keys</code> behavior is now correct even in browsers without native <code>Object.keys</code>. #192 @rkatic</li>
<li><code>isRejected</code> and the <code>exception</code> property now work correctly if the rejection reason is falsy. #198</li>
</ul>
<h2><a class="anchor" id="autotoc_md16092"></a>
Internals and Advanced</h2>
<ul>
...
<h1><a class="anchor" id="autotoc_md16093"></a>
0.8.12</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16094"></a>
0.8.11</h1>
<ul>
...
<li>Fixed <code>Q.timeout</code> to clear its timeout handle when the promise is rejected; previously, it kept the event loop alive until the timeout period expired. #145 @dfilatov</li>
<li>Added <code>q/queue</code> module, which exports an infinite promise queue constructor.</li>
</ul>
<h1><a class="anchor" id="autotoc_md16095"></a>
0.8.10</h1>
<ul>
...
<li>Added <code>thenResolve</code> as a shortcut for returning a constant value once a promise is fulfilled. #108 @ForbesLindesay</li>
...
<h1><a class="anchor" id="autotoc_md16096"></a>
0.8.9</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16097"></a>
0.8.7</h1>
<ul>
<li>Support <a href="http://github.com/kriskowal/mr">Montage Require</a></li>
</ul>
<h1><a class="anchor" id="autotoc_md16098"></a>
0.8.6</h1>
<ul>
<li>Fixed <code>npost</code> and <code>ninvoke</code> to pass the correct <code>thisp</code>. #74</li>
<li>Fixed various cases involving unorthodox rejection reasons. #73 #90 @ef4</li>
<li>Fixed double-resolving of misbehaved custom promises. #75</li>
<li>Sped up <code>Q.all</code> for arrays contain already-resolved promises or scalar values. @ForbesLindesay</li>
...
<h1><a class="anchor" id="autotoc_md16099"></a>
0.8.5</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16100"></a>
0.8.4</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16101"></a>
0.8.3</h1>
<ul>
<li>Added <code>isFulfilled</code>, <code>isRejected</code>, and <code>isResolved</code> to the promise prototype.</li>
<li>Added <code>allResolved</code> for waiting for every promise to either be fulfilled or rejected, without propagating an error. @utvara #53</li>
<li>Added <code>Q.bind</code> as a method to transform functions that return and throw into promise-returning functions. See <a href="https://gist.github.com/1782808">an example</a>. @domenic</li>
<li>Renamed <code>node</code> export to <code>nbind</code>, and added <code>napply</code> to complete the set. <code>node</code> remains as deprecated. @domenic #58</li>
...
<h1><a class="anchor" id="autotoc_md16102"></a>
0.8.2</h1>
<ul>
<li>Deprecated <code>ref</code> in favor of <code>resolve</code> as recommended by @domenic.</li>
<li>Update event-queue dependency.</li>
</ul>
<h1><a class="anchor" id="autotoc_md16103"></a>
0.8.1</h1>
<ul>
<li>Fixed Opera bug. #35 @cadorn</li>
<li>Fixed <code>Q.all([])</code> #32 @domenic</li>
</ul>
<h1><a class="anchor" id="autotoc_md16104"></a>
0.8.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16105"></a>
0.7.2</h1>
<ul>
<li>Fixed thenable promise assimilation.</li>
</ul>
<h1><a class="anchor" id="autotoc_md16106"></a>
0.7.1</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16107"></a>
0.7.0 - BACKWARD INCOMPATIBILITY</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16108"></a>
0.6.0 - BACKWARD INCOMPATIBILITY</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16109"></a>
0.5.3</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16112"></a>
0.5.0 - MINOR BACKWARD INCOMPATIBILITY</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16113"></a>
0.4.4</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16117"></a>
0.4.0 - BACKWARD INCOMPATIBLE*</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16118"></a>
0.3.0 - BACKWARD-INCOMPATIBLE</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16121"></a>
0.2.8</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16122"></a>
0.2.7</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16123"></a>
0.2.6</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16124"></a>
0.2.5</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16125"></a>
0.2.4</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16129"></a>
0.2.0 - BACKWARD INCOMPATIBLE</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16130"></a>
0.1.9</h1>
<ul>
