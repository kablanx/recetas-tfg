...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_to-regex__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
<div class="PageDoc"><div class="header">
  <div class="headertitle">
<div class="title">to-regex <a href="https://www.npmjs.com/package/to-regex"><object type="image/svg+xml" data="https://img.shields.io/npm/v/to-regex.svg?style=flat" style="pointer-events: none;">NPM version</object></a> <a href="https://npmjs.org/package/to-regex"><object type="image/svg+xml" data="https://img.shields.io/npm/dm/to-regex.svg?style=flat" style="pointer-events: none;">NPM monthly downloads</object></a> <a href="https://npmjs.org/package/to-regex"><object type="image/svg+xml" data="https://img.shields.io/npm/dt/to-regex.svg?style=flat" style="pointer-events: none;">NPM total downloads</object></a> <a href="https://travis-ci.org/jonschlinkert/to-regex"><object type="image/svg+xml" data="https://img.shields.io/travis/jonschlinkert/to-regex.svg?style=flat&amp;label=Travis" style="pointer-events: none;">Linux Build Status</object></a> </div>  </div>
</div><!--header-->
<div class="contents">
...
<h1><a class="anchor" id="autotoc_md20196"></a>
Install</h1>
<p>Install with <a href="https://www.npmjs.com/">npm</a>:</p>
<div class="fragment"><div class="line">$ npm install --save to-regex</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md20197"></a>
Usage</h1>
<div class="fragment"><div class="line">var toRegex = require(&#39;to-regex&#39;);</div>
<div class="line"> </div>
<div class="line">console.log(toRegex(&#39;foo&#39;));</div>
<div class="line">//=&gt; /^(?:foo)$/</div>
<div class="line"> </div>
<div class="line">console.log(toRegex(&#39;foo&#39;, {negate: true}));</div>
<div class="line">//=&gt; /^(?:(?:(?!^(?:foo)$).)*)$/</div>
<div class="line"> </div>
<div class="line">console.log(toRegex(&#39;foo&#39;, {contains: true}));</div>
<div class="line">//=&gt; /(?:foo)/</div>
<div class="line"> </div>
<div class="line">console.log(toRegex([&#39;foo&#39;, &#39;bar&#39;], {negate: true}));</div>
<div class="line">//=&gt; /^(?:(?:(?!^(?:(?:foo)|(?:bar))$).)*)$/</div>
<div class="line"> </div>
<div class="line">console.log(toRegex([&#39;foo&#39;, &#39;bar&#39;], {negate: true, contains: true}));</div>
<div class="line">//=&gt; /^(?:(?:(?!(?:(?:foo)|(?:bar))).)*)$/</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md20198"></a>
Options</h1>
<h2><a class="anchor" id="autotoc_md20199"></a>
options.contains</h2>
...
<div class="line">console.log(toRegex(&#39;foo&#39;, {contains: true}));</div>
<div class="line">//=&gt; /(?:foo)/</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20200"></a>
options.negate</h2>
<p><b>Type</b>: <code>Boolean</code></p>
<p><b>Default</b>: <code>undefined</code></p>
...
<div class="line">console.log(toRegex(&#39;foo&#39;, {negate: true}));</div>
<div class="line">//=&gt; /^(?:(?:(?!^(?:foo)$).)*)$/</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20201"></a>
options.nocase</h2>
<p><b>Type</b>: <code>Boolean</code></p>
<p><b>Default</b>: <code>undefined</code></p>
<p>Adds the <code>i</code> flag, to enable case-insensitive matching.</p>
<div class="fragment"><div class="line">var toRegex = require(&#39;to-regex&#39;);</div>
<div class="line">console.log(toRegex(&#39;foo&#39;, {nocase: true}));</div>
<div class="line">//=&gt; /^(?:foo)$/i</div>
</div><!-- fragment --><p>Alternatively you can pass the flags you want directly on <a href="#options.flags">options.flags</a>.</p>
<h2><a class="anchor" id="autotoc_md20202"></a>
options.flags</h2>
<p><b>Type</b>: <code>String</code></p>
<p><b>Default</b>: <code>undefined</code></p>
<p>Define the flags you want to use on the generated regex.</p>
<div class="fragment"><div class="line">var toRegex = require(&#39;to-regex&#39;);</div>
<div class="line">console.log(toRegex(&#39;foo&#39;, {flags: &#39;gm&#39;}));</div>
<div class="line">//=&gt; /^(?:foo)$/gm</div>
<div class="line">console.log(toRegex(&#39;foo&#39;, {flags: &#39;gmi&#39;, nocase: true})); //&lt;= handles redundancy</div>
<div class="line">//=&gt; /^(?:foo)$/gmi</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20203"></a>
options.cache</h2>
<p><b>Type</b>: <code>Boolean</code></p>
...
<p><b>Disable caching</b></p>
<div class="fragment"><div class="line">toRegex(&#39;foo&#39;, {cache: false});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20204"></a>
options.safe</h2>
<p><b>Type</b>: <code>Boolean</code></p>
<p><b>Default</b>: <code>undefined</code></p>
...
<p><b>Examples</b></p>
<div class="fragment"><div class="line">console.log(toRegex(&#39;(x+x+)+y&#39;));</div>
<div class="line">//=&gt; /^(?:(x+x+)+y)$/</div>
<div class="line"> </div>
<div class="line">// The following would throw an error</div>
<div class="line">toRegex(&#39;(x+x+)+y&#39;, {safe: true});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md20205"></a>
About</h1>
<p>&lt;details&gt;</p>
...
<h2><a class="anchor" id="autotoc_md20206"></a>
Related projects</h2>
...
<h2><a class="anchor" id="autotoc_md20207"></a>
Author</h2>
...
<h2><a class="anchor" id="autotoc_md20208"></a>
License</h2>
