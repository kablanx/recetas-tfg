...
<title>Food4uDoc: PostCSS Plugin Guidelines</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_postcss-modules-local-by-default_node_modules_postcss_docs_guidelines_plugin.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<h1><a class="anchor" id="autotoc_md14640"></a>
1. API</h1>
<h2><a class="anchor" id="autotoc_md14641"></a>
...
<h2><a class="anchor" id="autotoc_md14642"></a>
...
<h2><a class="anchor" id="autotoc_md14643"></a>
...
<h2><a class="anchor" id="autotoc_md14644"></a>
...
<div class="fragment"><div class="line">module.exports = postcss.plugin(&#39;plugin-name&#39;, function (opts) {</div>
<div class="line">    return function (root, result) {</div>
<div class="line">        // Plugin code</div>
<div class="line">    };</div>
<div class="line">});</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md14645"></a>
2. Processing</h1>
<h2><a class="anchor" id="autotoc_md14646"></a>
...
<h2><a class="anchor" id="autotoc_md14647"></a>
...
<div class="fragment"><div class="line">postcss.plugin(&#39;plugin-sprite&#39;, function (opts) {</div>
<div class="line">    return function (root, result) {</div>
<div class="line"> </div>
<div class="line">        return new Promise(function (resolve, reject) {</div>
<div class="line">            var sprite = makeSprite();</div>
<div class="line">            fs.writeFile(opts.file, function (err) {</div>
...
<div class="line">    };</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14648"></a>
...
<div class="line">    var keyframe = createAnimationByName(decl.value);</div>
<div class="line">    keyframes.source = decl.source;</div>
<div class="line">    decl.root().append(keyframes);</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14649"></a>
...
<h1><a class="anchor" id="autotoc_md14650"></a>
3. Errors</h1>
<h2><a class="anchor" id="autotoc_md14651"></a>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md14652"></a>
...
<h1><a class="anchor" id="autotoc_md14653"></a>
4. Documentation</h1>
<h2><a class="anchor" id="autotoc_md14654"></a>
...
<h2><a class="anchor" id="autotoc_md14655"></a>
...
<h2><a class="anchor" id="autotoc_md14656"></a>
...
<h2><a class="anchor" id="autotoc_md14657"></a>
