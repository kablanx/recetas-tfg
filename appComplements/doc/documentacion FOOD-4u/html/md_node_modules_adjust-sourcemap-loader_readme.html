...
<title>Food4uDoc: Adjust Source-map Loader</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_adjust-sourcemap-loader_readme.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md1025"></a>
...
<div class="line">  }</div>
<div class="line">};</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md1028"></a>
Options</h1>
...
<li>**<code>format</code>** : <code>string</code> Optional output format for source-map <code>sources</code>. Must be the camel-case name of one of the available <code>codecs</code>. Omitting the format will result in <b>no change</b> and the outgoing source-map will match the incomming one.</li>
