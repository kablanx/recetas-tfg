...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_sockjs__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="contents">
<div class="textblock"><p><a href="http://badge.fury.io/js/sockjs"><object type="image/svg+xml" data="https://badge.fury.io/js/sockjs.svg" style="pointer-events: none;">NPM version</object></a></p>
<p>SockJS family:</p>
<ul>
...
<h1><a class="anchor" id="autotoc_md18186"></a>
What is SockJS?</h1>
...
<h1><a class="anchor" id="autotoc_md18187"></a>
SockJS-node server</h1>
...
<div class="line">var sockjs = require(&#39;sockjs&#39;);</div>
<div class="line"> </div>
<div class="line">var echo = sockjs.createServer();</div>
<div class="line">echo.on(&#39;connection&#39;, function(conn) {</div>
<div class="line">    conn.on(&#39;data&#39;, function(message) {</div>
<div class="line">        conn.write(message);</div>
<div class="line">    });</div>
<div class="line">    conn.on(&#39;close&#39;, function() {});</div>
<div class="line">});</div>
<div class="line"> </div>
<div class="line">var server = http.createServer();</div>
<div class="line">echo.installHandlers(server, {prefix:&#39;/echo&#39;});</div>
<div class="line">server.listen(9999, &#39;0.0.0.0&#39;);</div>
</div><!-- fragment --><p>(Take look at <a href="https://github.com/sockjs/sockjs-node/tree/master/examples/echo">examples</a> directory for a complete version.)</p>
<p>Subscribe to <a href="https://groups.google.com/forum/#!forum/sockjs">SockJS mailing list</a> for discussions and support.</p>
<h2><a class="anchor" id="autotoc_md18188"></a>
SockJS-node API</h2>
<p>The API design is based on common Node APIs like the <a href="http://nodejs.org/docs/v0.5.8/api/streams.html">Streams API</a> or the <a href="http://nodejs.org/docs/v0.5.8/api/http.html#http.Server">Http.Server API</a>.</p>
<h3><a class="anchor" id="autotoc_md18189"></a>
Server class</h3>
...
<div class="fragment"><div class="line">var sockjs_server = sockjs.createServer(options);</div>
</div><!-- fragment --><p>Where <code>options</code> is a hash which can contain:</p>
<dl>
...
<dd><p class="startdd">The server sends a <code>close</code> event when a client receiving connection have not been seen for a while. This delay is configured by this setting. By default the <code>close</code> event will be emitted when a receiving connection wasn't seen for 5 seconds. </p>
<p class="enddd"></p>
</dd>
<dt>disable_cors (boolean) </dt>
<dd>Enabling this option will prevent <a href="https://en.wikipedia.org/wiki/Cross-origin_resource_sharing">CORS</a> headers from being included in the HTTP response. Can be used when the sockjs client is known to be connecting from the same origin as the sockjs server. </dd>
</dl>
<h3><a class="anchor" id="autotoc_md18190"></a>
Server instance</h3>
...
<div class="fragment"><div class="line">var http_server = http.createServer();</div>
<div class="line">sockjs_server.installHandlers(http_server, options);</div>
<div class="line">http_server.listen(...);</div>
</div><!-- fragment --><p>Where <code>options</code> can overshadow options given when creating <code>Server</code> instance.</p>
...
<h3><a class="anchor" id="autotoc_md18191"></a>
Connection instance</h3>
...
<p>For example:</p>
<div class="fragment"><div class="line">sockjs_server.on(&#39;connection&#39;, function(conn) {</div>
<div class="line">    console.log(&#39;connection&#39; + conn);</div>
<div class="line">    conn.on(&#39;close&#39;, function() {</div>
<div class="line">        console.log(&#39;close &#39; + conn);</div>
<div class="line">    });</div>
<div class="line">    conn.on(&#39;data&#39;, function(message) {</div>
<div class="line">        console.log(&#39;message &#39; + conn,</div>
<div class="line">                    message);</div>
<div class="line">    });</div>
<div class="line">});</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md18192"></a>
Footnote</h3>
...
<h3><a class="anchor" id="autotoc_md18193"></a>
Examples</h3>
...
<h2><a class="anchor" id="autotoc_md18194"></a>
Connecting to SockJS-node without the client</h2>
...
<h2><a class="anchor" id="autotoc_md18195"></a>
Deployment and load balancing</h2>
...
<h3><a class="anchor" id="autotoc_md18196"></a>
WebSocket compatible load balancer</h3>
...
<h3><a class="anchor" id="autotoc_md18197"></a>
Sticky sessions</h3>
...
<h2><a class="anchor" id="autotoc_md18198"></a>
...
</pre><h3><a class="anchor" id="autotoc_md18199"></a>
SockJS-protocol Python tests</h3>
...
<h3><a class="anchor" id="autotoc_md18200"></a>
SockJS-client QUnit tests</h3>
...
<h2><a class="anchor" id="autotoc_md18201"></a>
Various issues and design considerations</h2>
<h3><a class="anchor" id="autotoc_md18202"></a>
Authorisation</h3>
...
<h3><a class="anchor" id="autotoc_md18203"></a>
Deploying SockJS on Heroku</h3>
