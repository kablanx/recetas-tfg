...
<title>Food4uDoc: Browserslist &lt;a href=&quot;https://cultofmartians.com/done.html&quot;&gt;&lt;img src=&quot;https://cultofmartians.com/assets/badges/badge.svg&quot; alt=&quot;Cult Of Martians&quot;/&gt;&lt;/a&gt;</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_node_modules_browserslist__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
<div class="PageDoc"><div class="header">
  <div class="headertitle">
<div class="title">Browserslist <a href="https://cultofmartians.com/done.html"><object type="image/svg+xml" data="https://cultofmartians.com/assets/badges/badge.svg" style="pointer-events: none;">Cult Of Martians</object></a> </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p><object type="image/svg+xml" data="https://browserslist.github.io/browserslist/logo.svg" style="pointer-events: none;" width="120" height="120" align="right">Browserslist logo by Anton Lovchikov</object></p>
...
<div class="line">]</div>
</div><!-- fragment --><p>Or in <code>.browserslistrc</code> config:</p>
...
<div class="line">not IE_Mob 11</div>
<div class="line">maintained node versions</div>
</div><!-- fragment --><p>Developers set their version lists using queries like <code>last 2 versions</code> to be free from updating versions manually. Browserslist&#160;will&#160;use <a href="https://github.com/ben-eb/caniuse-lite"><code>caniuse-lite</code></a> with&#160;<a href="https://caniuse.com/">Can I Use</a> data for this queries.</p>
...
<p><a href="https://github.com/browserslist/browserslist-example">Browserslist Example</a> shows how every tool uses Browserslist.</p>
<p><a href="https://evilmartians.com/?utm_source=browserslist"><object type="image/svg+xml" data="https://evilmartians.com/badges/sponsored-by-evil-martians.svg" style="pointer-events: none;" width="236" height="54">Sponsored by Evil Martians</object> </a></p>
...
<p><code>and</code> query combinations are also supported to perform an intersection of the previous query: <code>last 1 version and &gt; 1%</code>.</p>
<p>There is 3 different ways to combine queries as depicted below. First you start with a single query and then we combine the&#160;queries to get our final list.</p>
...
<p><code>and</code> combiner has precedence over <code>or</code> combiner.</p>
...
<td class="markdownTableBodyNone"><code>or</code>/<code>,</code> combiner <br  />
 (union) </td><td class="markdownTableBodyCenter"><object type="image/svg+xml" data="img/union.svg" style="pointer-events: none;">Union of queries</object> </td><td class="markdownTableBodyNone"><code>&gt; .5% or last 2 versions</code> <br  />
 <code>&gt; .5%, last 2 versions</code>  </td></tr>
<tr class="markdownTableRowEven">
<td class="markdownTableBodyNone"><code>and</code> combiner <br  />
 (intersection) </td><td class="markdownTableBodyCenter"><object type="image/svg+xml" data="img/intersection.svg" style="pointer-events: none;">intersection of queries</object> </td><td class="markdownTableBodyNone"><code>&gt; .5% and last 2 versions</code>  </td></tr>
<tr class="markdownTableRowOdd">
<td class="markdownTableBodyNone"><code>not</code> combiner <br  />
 (relative complement) </td><td class="markdownTableBodyCenter"><object type="image/svg+xml" data="img/complement.svg" style="pointer-events: none;">Relative complement of queries</object> </td><td class="markdownTableBodyNone">All those three are equivalent to the first one <br  />
 <code>&gt; .5% and not last 2 versions</code> <br  />
 <code>&gt; .5% or not last 2 versions</code> <br  />
 <code>&gt; .5%, not last 2 versions</code>  </td></tr>
</table>
<p>_A quick way to test your query is to do &lsquo;npx browserslist &rsquo;&gt; 0.5%, not IE 11'` in your terminal._</p>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md2626"></a>
Browsers</h2>
...
<div class="line">  ]</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md2629"></a>
...
</div><!-- fragment --><p>Browserslist will check config in every directory in <code>path</code>. So, if tool process <code>app/styles/main.css</code>, you can put config to root, <code>app/</code> or <code>app/styles</code>.</p>
...
<div class="line">]</div>
</div><!-- fragment --><p>For security reasons, external configuration only supports packages that have the <code>browserslist-config-</code> prefix. npm scoped packages are also supported, by naming or prefixing the module with <code>@scope/browserslist-config</code>, such as <code>@scope/browserslist-config</code> or <code>@scope/browserslist-config-mycompany</code>.</p>
<p>If&#160;you&#160;don’t&#160;accept Browserslist queries from users, you can disable the validation by using the <code>dangerousExtend</code> option:</p>
<div class="fragment"><div class="line">browserslist(queries, { path, dangerousExtend: true })</div>
</div><!-- fragment --><p>Because this uses <code>npm</code>'s resolution, you can also reference specific files in a package:</p>
<div class="fragment"><div class="line">&quot;browserslist&quot;: [</div>
...
<div class="line">]</div>
</div><!-- fragment --><p>When writing a shared Browserslist package, just export an array. <code>browserslist-config-mycompany/index.js</code>:</p>
<div class="fragment"><div class="line">module.exports = [</div>
<div class="line">  &#39;last 1 version&#39;,</div>
<div class="line">  &#39;&gt; 1%&#39;,</div>
<div class="line">  &#39;ie 10&#39;</div>
<div class="line">]</div>
</div><!-- fragment --><p>You can also include a <code>browserslist-stats.json</code> file as part of your shareable config at the root and query it using <code>&gt; 5% in browserslist-config-mycompany stats</code>. It uses the same format as <code>extends</code> and the <code>dangerousExtend</code> property as above.</p>
...
<div class="line">  ]</div>
<div class="line">}</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md2631"></a>
...
<div class="line">  ]</div>
<div class="line">}</div>
</div><!-- fragment --><p>In <code>.browserslistrc</code> config:</p>
...
<div class="line">[ssr]</div>
<div class="line">node 12</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md2632"></a>
...
</div><!-- fragment --><p>Or you can use <a href="https://github.com/browserslist/browserslist-ga-export"><code>browserslist-ga-export</code></a> to convert Google Analytics data without giving a password for Google account.</p>
...
<div class="line">  …</div>
<div class="line">}</div>
</div><!-- fragment --><p>Note that you can query against your custom usage data while also querying against global or regional data. For&#160;example,&#160;the query <code>&gt; 1% in my stats, &gt; 5% in US, 10%</code> is permitted.</p>
<h1><a class="anchor" id="autotoc_md2633"></a>
JS API</h1>
...
<div class="line">}</div>
</div><!-- fragment --><p>Queries can be a string <code>"&gt; 1%, IE 10"</code> or an array &lsquo;[&rsquo;&gt; 1', 'IE 10']`.</p>
...
</div><!-- fragment --><p>You can get total users coverage for selected browsers by JS API:</p>
...
<p>If a tool uses Browserslist inside, you can change the Browserslist settings with [environment variables]:</p>
<ul>
<li><code>BROWSERSLIST</code> with browsers queries.</li>
</ul>
<div class="fragment"><div class="line">BROWSERSLIST=&quot;&gt; 5%&quot; gulp css</div>
</div><!-- fragment --><ul>
<li><code>BROWSERSLIST_CONFIG</code> with path to config file.</li>
</ul>
<div class="fragment"><div class="line">BROWSERSLIST_CONFIG=./config/browserslist gulp css</div>
</div><!-- fragment --><ul>
<li><code>BROWSERSLIST_ENV</code> with environments string.</li>
</ul>
<div class="fragment"><div class="line">BROWSERSLIST_ENV=&quot;development&quot; gulp css</div>
</div><!-- fragment --><ul>
<li><code>BROWSERSLIST_STATS</code> with path to the custom usage data for <code>&gt; 1% in my stats</code> query.</li>
</ul>
<div class="fragment"><div class="line">BROWSERSLIST_STATS=./config/usage_data.json gulp css</div>
</div><!-- fragment --><ul>
<li><code>BROWSERSLIST_DISABLE_CACHE</code> if you want to disable config reading cache.</li>
</ul>
<div class="fragment"><div class="line">BROWSERSLIST_DISABLE_CACHE=1 gulp css</div>
...
</div><!-- fragment --><p>To disable the caching altogether, set the <code>BROWSERSLIST_DISABLE_CACHE</code> environment variable.</p>
